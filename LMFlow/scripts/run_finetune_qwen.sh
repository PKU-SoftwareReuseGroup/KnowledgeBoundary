...
model_name_or_path=/data/data_public/breeze/models/Qwen/Qwen2-1.5B-Instruct
#RAIT数据集
dataset_path=/data/data_public/breeze/KnowledgeBoundary/2.2.2_TASK/2.2.2_0_ModelGenData/Qwen2-1.5B-Instruct
# #筛选后的数据集
# dataset_path=/data/data_public/breeze/KnowledgeBoundary/LMFlow/2.2.2_2_RES_DATASET/llama3b

output_dir=/data/data_public/breeze/output_models/finetuned_Qwen2-1.5B-Instruct-N
