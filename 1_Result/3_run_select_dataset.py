...
#CORCER 路径
pre_res_path = "/data/data_public/breeze/KnowledgeBoundary/1_Result/evalution_res/Qwen2-1.5B-Instruct/CORCER_Qwen2-1.5B-Instruct.json"
aft_res_path = "/data/data_public/breeze/KnowledgeBoundary/1_Result/evalution_res/Qwen2_1.5B-Instruct-LFfinefune/CORCER_Qwen2_1.5B-Instruct-LFfinefune.json"
#RAIT数据集 路径
RAITset_path = "/data/data_public/breeze/KnowledgeBoundary/1_Result/ModelGenData/Qwen2-1.5B-Instruct/MMLU.json"
...
res_CER_Change_Data_path = "./RES_DATASET/QWen2-1.5B/sub_CorCerChange.json"
res_CER_Change_Data_path_LF = "./RES_DATASET/QWen2-1.5B/sub_CorCerChange_LF.json"
...
PATH_LF_RAIT = f"/data/data_public/breeze/KnowledgeBoundary/1_Result/ModelGenData/Qwen2-1.5B-Instruct/MMLU_LF.json"

PATHRES_LF_RAIT = f"/data/data_public/breeze/KnowledgeBoundary/1_Result/RES_DATASET/QWen2-1.5B_finetined_LF/MMLU_LF_{RATIO}.json"
