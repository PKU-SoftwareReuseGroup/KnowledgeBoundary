...
pre_res_path = "/data/data_public/breeze/KnowledgeBoundary/2.2.2_TASK/2.2.2_1_evalution_res/CORCER_Qwen2-1.5B-Instruct.json"
aft_res_path = "/data/data_public/breeze/KnowledgeBoundary/2.2.2_TASK/2.2.2_1_evalution_res/CORCER_finetuned_Qwen2-1.5B-Instruct-N.json"

RAITset_path = "/data/data_public/breeze/KnowledgeBoundary/2.2.2_TASK/2.2.2_0_ModelGenData/Qwen2-1.5B-Instruct/MMLU_unsure.json"
...
res_CER_Change_Data_path = "./2.2.2_2_RES_DATASET/qwen/sub_CerChange.json"
#根据CER筛选数据集的比例
RATIO = 0.5
